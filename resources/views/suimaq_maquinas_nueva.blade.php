...
<title>Suimaq | Admin Mantenimientos</title>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="suimaq_clientes.html">Clientes</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="#">Máquinas</a>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="btn-group">
								...
								<i class="fa fa-plus"></i> Nueva maquina
								</button>
							</div>
						</div>
						<div class="col-md-6">
							<label class="pull-right">Buscar: <input type="search" class="form-control input-large input-inline" placeholder="Ej: F130087, ERC 570, CAI78912, ..." aria-controls="sample_1"></label>
						</div>
					</div>
				</div>
					...
					<table class="table table-striped table-hover table-bordered dataTable no-footer">
						...
						<tbody>
							<tr>
								<td>1</td>
								<td>Worthington</td>
								<td>RLR220 | <a href="#"><small><i class="fa fa-download"></i> Manual</small></a></td>
								<td>F130087</td>
							...
							<tr>
								...
								<td>R34</td>
								<td>ERC 507L</td>
								<td>Carrer Numancia 20 Barcelona 08029 | <a href="#"><small><i class="fa fa-map-marker"></i> Cómo llegar</small></a> </td>
								<td>
								<a href="#" class="btn default btn-xs purple-stripe"><i class="fa fa-history"></i></a>
								<a href="#" class="btn default btn-xs green-stripe"><i class="fa fa-edit"></i></a>
								<a href="#" class="btn default btn-xs red-stripe"><i class="fa fa-times"></i></a>
